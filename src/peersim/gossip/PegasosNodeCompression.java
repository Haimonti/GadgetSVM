 ...
 *
 */
public class PegasosNodeCompression implements Node
{
	// ================= fields ========================================
		// =================================================================
		...
		public PegasosNodeCompression(String prefix) 
		{
		...
		public Object clone() 
		{
			PegasosNodeCompression result = null;
			try
			{ 
				result=(PegasosNodeCompression)super.clone(); 
			}
